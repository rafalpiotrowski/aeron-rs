pub use decoder::AttachSegmentsRequestDecoder;
pub use encoder::AttachSegmentsRequestEncoder;

use crate::*;

pub const SBE_BLOCK_LENGTH: u16 = 24;
pub const SBE_TEMPLATE_ID: u16 = 56;
...
pub mod encoder {
    ...
    pub struct AttachSegmentsRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AttachSegmentsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AttachSegmentsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> AttachSegmentsRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct AttachSegmentsRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for AttachSegmentsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AttachSegmentsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AttachSegmentsRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AttachSegmentsRequestDecoder<'a> {
