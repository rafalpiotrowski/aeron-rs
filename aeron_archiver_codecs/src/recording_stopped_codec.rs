pub use decoder::RecordingStoppedDecoder;
pub use encoder::RecordingStoppedEncoder;
...
pub mod encoder {
    ...
    pub struct RecordingStoppedEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RecordingStoppedEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RecordingStoppedEncoder<'a> {
        #[inline]
    ...
    impl<'a> RecordingStoppedEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RecordingStoppedDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for RecordingStoppedDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RecordingStoppedDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RecordingStoppedDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RecordingStoppedDecoder<'a> {
