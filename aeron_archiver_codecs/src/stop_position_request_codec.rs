pub use decoder::StopPositionRequestDecoder;
pub use encoder::StopPositionRequestEncoder;
...
pub mod encoder {
    ...
    pub struct StopPositionRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StopPositionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StopPositionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> StopPositionRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct StopPositionRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for StopPositionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StopPositionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StopPositionRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> StopPositionRequestDecoder<'a> {
