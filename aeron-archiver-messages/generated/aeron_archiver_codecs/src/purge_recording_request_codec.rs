...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for PurgeRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for PurgeRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> PurgeRecordingRequestEncoder<'a> {
...
pub mod decoder {
    ...
    impl<'a> ActingVersion for PurgeRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for PurgeRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for PurgeRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
