pub use decoder::RecordingStartedDecoder;
pub use encoder::RecordingStartedEncoder;
...
pub mod encoder {
    ...
    pub struct RecordingStartedEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RecordingStartedEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RecordingStartedEncoder<'a> {
        #[inline]
    ...
    impl<'a> RecordingStartedEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RecordingStartedDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for RecordingStartedDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RecordingStartedDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RecordingStartedDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RecordingStartedDecoder<'a> {
