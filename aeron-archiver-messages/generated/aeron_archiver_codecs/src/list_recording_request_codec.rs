pub use decoder::ListRecordingRequestDecoder;
pub use encoder::ListRecordingRequestEncoder;
...
pub mod encoder {
    ...
    pub struct ListRecordingRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ListRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> ListRecordingRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ListRecordingRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ListRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ListRecordingRequestDecoder<'a> {
