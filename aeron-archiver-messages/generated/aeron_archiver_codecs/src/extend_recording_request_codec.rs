pub use decoder::ExtendRecordingRequestDecoder;
pub use encoder::ExtendRecordingRequestEncoder;
...
pub mod encoder {
    ...
    pub struct ExtendRecordingRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExtendRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExtendRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExtendRecordingRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExtendRecordingRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExtendRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExtendRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExtendRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExtendRecordingRequestDecoder<'a> {
