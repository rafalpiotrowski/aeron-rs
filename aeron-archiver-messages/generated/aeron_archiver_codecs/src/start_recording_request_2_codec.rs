...
pub use decoder::StartRecordingRequest2Decoder;
pub use encoder::StartRecordingRequest2Encoder;

pub const SBE_BLOCK_LENGTH: u16 = 28;
pub const SBE_TEMPLATE_ID: u16 = 63;
...
pub mod encoder {
    ...
    pub struct StartRecordingRequest2Encoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StartRecordingRequest2Encoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StartRecordingRequest2Encoder<'a> {
        #[inline]
    ...
    impl<'a> StartRecordingRequest2Encoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn source_location(&mut self, value: source_location::SourceLocation) {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn auto_stop(&mut self, value: boolean_type::BooleanType) {
...
pub mod decoder {
    ...
    pub struct StartRecordingRequest2Decoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for StartRecordingRequest2Decoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StartRecordingRequest2Decoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StartRecordingRequest2Decoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> StartRecordingRequest2Decoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn source_location(&self) -> source_location::SourceLocation {
            self.get_buf().get_i32_at(self.offset + 20).into()
        }

        /// REQUIRED enum
        #[inline]
        pub fn auto_stop(&self) -> boolean_type::BooleanType {
