...
pub use decoder::FindLastMatchingRecordingRequestDecoder;
pub use encoder::FindLastMatchingRecordingRequestEncoder;
...
pub mod encoder {
    ...
    pub struct FindLastMatchingRecordingRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for FindLastMatchingRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for FindLastMatchingRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> FindLastMatchingRecordingRequestEncoder<'a> {
        ...
        /// primitive field 'minRecordingId'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn min_recording_id(&mut self, value: i64) {
...
pub mod decoder {
    ...
    pub struct FindLastMatchingRecordingRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for FindLastMatchingRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for FindLastMatchingRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for FindLastMatchingRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> FindLastMatchingRecordingRequestDecoder<'a> {
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn min_recording_id(&self) -> i64 {
