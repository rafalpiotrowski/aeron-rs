...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for CloseSessionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CloseSessionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> CloseSessionRequestEncoder<'a> {
...
pub mod decoder {
    ...
    impl<'a> ActingVersion for CloseSessionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for CloseSessionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CloseSessionRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
