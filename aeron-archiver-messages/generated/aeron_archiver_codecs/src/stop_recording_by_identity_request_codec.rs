pub use decoder::StopRecordingByIdentityRequestDecoder;
pub use encoder::StopRecordingByIdentityRequestEncoder;

use crate::*;

pub const SBE_BLOCK_LENGTH: u16 = 24;
pub const SBE_TEMPLATE_ID: u16 = 65;
...
pub mod encoder {
    ...
    pub struct StopRecordingByIdentityRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StopRecordingByIdentityRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StopRecordingByIdentityRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> StopRecordingByIdentityRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct StopRecordingByIdentityRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for StopRecordingByIdentityRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StopRecordingByIdentityRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StopRecordingByIdentityRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
