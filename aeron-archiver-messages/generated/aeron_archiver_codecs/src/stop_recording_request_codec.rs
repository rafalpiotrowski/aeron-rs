...
pub use decoder::StopRecordingRequestDecoder;
pub use encoder::StopRecordingRequestEncoder;
...
pub mod encoder {
    ...
    pub struct StopRecordingRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StopRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StopRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> StopRecordingRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct StopRecordingRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for StopRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StopRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StopRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
