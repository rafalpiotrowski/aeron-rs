...
pub use decoder::StartPositionRequestDecoder;
pub use encoder::StartPositionRequestEncoder;
...
pub mod encoder {
    ...
    pub struct StartPositionRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for StartPositionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for StartPositionRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> StartPositionRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct StartPositionRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for StartPositionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for StartPositionRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for StartPositionRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> StartPositionRequestDecoder<'a> {
