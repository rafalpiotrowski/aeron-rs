pub use decoder::RecordingProgressDecoder;
pub use encoder::RecordingProgressEncoder;
...
pub mod encoder {
    ...
    pub struct RecordingProgressEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RecordingProgressEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RecordingProgressEncoder<'a> {
        #[inline]
    ...
    impl<'a> RecordingProgressEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RecordingProgressDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for RecordingProgressDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RecordingProgressDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RecordingProgressDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RecordingProgressDecoder<'a> {
