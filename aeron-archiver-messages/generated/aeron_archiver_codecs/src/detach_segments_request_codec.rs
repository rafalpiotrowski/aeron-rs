pub use decoder::DetachSegmentsRequestDecoder;
pub use encoder::DetachSegmentsRequestEncoder;
...
pub mod encoder {
    ...
    pub struct DetachSegmentsRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for DetachSegmentsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for DetachSegmentsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> DetachSegmentsRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct DetachSegmentsRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for DetachSegmentsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for DetachSegmentsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for DetachSegmentsRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> DetachSegmentsRequestDecoder<'a> {
