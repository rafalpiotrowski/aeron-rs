...
pub use decoder::AuthConnectRequestDecoder;
pub use encoder::AuthConnectRequestEncoder;

pub const SBE_BLOCK_LENGTH: u16 = 16;
pub const SBE_TEMPLATE_ID: u16 = 58;
...
pub mod encoder {
    ...
    pub struct AuthConnectRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for AuthConnectRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for AuthConnectRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> AuthConnectRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct AuthConnectRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for AuthConnectRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for AuthConnectRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for AuthConnectRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> AuthConnectRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
