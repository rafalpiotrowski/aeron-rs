...
pub use decoder::TruncateRecordingRequestDecoder;
pub use encoder::TruncateRecordingRequestEncoder;
...
pub mod encoder {
    ...
    pub struct TruncateRecordingRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TruncateRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TruncateRecordingRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> TruncateRecordingRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct TruncateRecordingRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for TruncateRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TruncateRecordingRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TruncateRecordingRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TruncateRecordingRequestDecoder<'a> {
