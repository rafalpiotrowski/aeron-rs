...
pub use decoder::BoundedReplayRequestDecoder;
pub use encoder::BoundedReplayRequestEncoder;

pub const SBE_BLOCK_LENGTH: u16 = 52;
pub const SBE_TEMPLATE_ID: u16 = 18;
...
pub mod encoder {
    ...
    pub struct BoundedReplayRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for BoundedReplayRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for BoundedReplayRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> BoundedReplayRequestEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn length(&mut self, value: i64) {
            let offset = self.offset + 32;
            self.get_buf_mut().put_i64_at(offset, value);
        }

        /// primitive field 'limitCounterId'
        ...
        /// - version: 0
        #[inline]
        pub fn limit_counter_id(&mut self, value: i32) {
            let offset = self.offset + 40;
            self.get_buf_mut().put_i32_at(offset, value);
        }

        /// primitive field 'replayStreamId'
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn replay_stream_id(&mut self, value: i32) {
        ...
        #[inline]
        pub fn replay_channel(&mut self, value: &[u8]) {
...
pub mod decoder {
    ...
    pub struct BoundedReplayRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for BoundedReplayRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for BoundedReplayRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for BoundedReplayRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> BoundedReplayRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn limit_counter_id(&self) -> i32 {
            self.get_buf().get_i32_at(self.offset + 40)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn replay_stream_id(&self) -> i32 {
        ...
        #[inline]
        pub fn replay_channel_decoder(&mut self) -> (usize, usize) {
        ...
        #[inline]
        pub fn replay_channel_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
