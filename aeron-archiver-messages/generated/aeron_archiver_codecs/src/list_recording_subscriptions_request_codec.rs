pub use decoder::ListRecordingSubscriptionsRequestDecoder;
pub use encoder::ListRecordingSubscriptionsRequestEncoder;
...
pub mod encoder {
    ...
    pub struct ListRecordingSubscriptionsRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ListRecordingSubscriptionsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListRecordingSubscriptionsRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> ListRecordingSubscriptionsRequestEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn pseudo_index(&mut self, value: i32) {
            let offset = self.offset + 16;
            self.get_buf_mut().put_i32_at(offset, value);
        }

        /// primitive field 'subscriptionCount'
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn subscription_count(&mut self, value: i32) {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn apply_stream_id(&mut self, value: boolean_type::BooleanType) {
...
pub mod decoder {
    ...
    pub struct ListRecordingSubscriptionsRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ListRecordingSubscriptionsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListRecordingSubscriptionsRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListRecordingSubscriptionsRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ListRecordingSubscriptionsRequestDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn apply_stream_id(&self) -> boolean_type::BooleanType {
