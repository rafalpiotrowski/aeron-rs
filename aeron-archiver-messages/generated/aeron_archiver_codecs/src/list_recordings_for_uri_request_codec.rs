...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for ListRecordingsForUriRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ListRecordingsForUriRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> ListRecordingsForUriRequestEncoder<'a> {
...
pub mod decoder {
    ...
    impl<'a> ActingVersion for ListRecordingsForUriRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ListRecordingsForUriRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ListRecordingsForUriRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
