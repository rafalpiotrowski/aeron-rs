...
pub use decoder::RecordingSubscriptionDescriptorDecoder;
pub use encoder::RecordingSubscriptionDescriptorEncoder;
...
pub mod encoder {
    ...
    pub struct RecordingSubscriptionDescriptorEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for RecordingSubscriptionDescriptorEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for RecordingSubscriptionDescriptorEncoder<'a> {
        #[inline]
    ...
    impl<'a> RecordingSubscriptionDescriptorEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct RecordingSubscriptionDescriptorDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for RecordingSubscriptionDescriptorDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for RecordingSubscriptionDescriptorDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for RecordingSubscriptionDescriptorDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> RecordingSubscriptionDescriptorDecoder<'a> {
